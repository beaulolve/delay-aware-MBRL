...
{  
    ...
    void Start()
    {
        ros.Subscribe<RosBattMsg>("/mavros/battery", UavBattSubscriber);
        ros.Subscribe<RosPoseMsg>("/mavros/local_position/pose", UavEnuPoseSubscriber);
        ros.Subscribe<RosVelMsg>("/mavros/local_position/velocity_local", UavEnuVelSubscriber);
        ros.Subscribe<RosStateMsg>("/mavros/state", UavStateSubscriber);
        ros.Subscribe<RosGlobalPosMsg>("/mavros/global_position/global", UavGlobalPosSubscriber);
    }
